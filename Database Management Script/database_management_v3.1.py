...
createApplications = "CREATE TABLE Applications(username varchar(50), firstName varchar(50), lastName varChar(50), year varchar(10), gpa float, grade320 char, referenceName varchar(100), referenceEmail varchar(100), attachment varchar(100), status int);"
...
createUsers = "CREATE TABLE Users(username varchar(50) primary key, password varchar(255), type Boolean, firstName varchar(50), lastName varchar(50), email varchar(50))"
...
def create_test_tables():
    curr.execute("CREATE TABLE Applications_test(username varchar(50), firstName varchar(50), lastName varChar(50), year varchar(10), gpa float, grade320 char, referenceName varchar(100), referenceEmail varchar(100), attachment varchar(100), status int);")
    ...
    curr.execute("CREATE TABLE Users_test(username varchar(50) primary key, password varchar(255), type Boolean, firstName varchar(50), lastName varchar(50), email varchar(50))")
...
def fill_dummy_values():
    ...
    #Applications_test: 
    curr.execute("INSERT INTO Applications_test(username, firstName, lastName, year, gpa, grade320, referenceName, referenceEmail, attachment, status) VALUES ('testusername', 'testFirst', 'testLast', 'Freshman', 3.2, 'A', 'firstRef lastRef', 'emailRef', 'testattachment', 2)")
    ...
    #Users_test:
    curr.execute("INSERT INTO Users_test(username, password, type, firstName, lastName, email) VALUES ('testUsername', 'testPassword', True, 'testFName', 'testLName', 'testEmail')")
